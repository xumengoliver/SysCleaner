...
public interface IEmptyItemScanService
{
    ...
    Task<IReadOnlyList<CleanupCandidate>> ExecuteAsync(string rootPath, IReadOnlyList<CleanupCandidate> selectedCandidates, IProgress<EmptyItemCleanupProgress>? progress = null, CancellationToken cancellationToken = default);
}